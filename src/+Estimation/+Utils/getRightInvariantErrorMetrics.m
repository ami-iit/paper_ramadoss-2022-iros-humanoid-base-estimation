function [rotError, posError, velError, ATErot, ATEpos, ATEvel, RPErot, RPEpos, rpyError] = getRightInvariantErrorMetrics(pos, rpy, vel, ...
...
for idx = 1:n
    ...
    rpyError(idx, :) = Utils.rot2rpy(deltaR);
