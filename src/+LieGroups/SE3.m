classdef SE3
    methods (Static)
        ...
        function Hout = sampleConcentratedGaussian(rpy_mean_rad, p_mean, sigma_tangent_space)
            Rmean = LieGroups.SO3.fromRPY(rpy_mean_rad);
            Hmean = LieGroups.SE3.constructSE3(Rmean, p_mean);
            epsilon = randn*sigma_tangent_space;
            Hout = Hmean*LieGroups.SE3.exphat(epsilon);
        end
