classdef EstCollector < handle 
    ...
    methods
        ...
        function obj = resizeBuffers(obj, size, Nl, Nr)
            ...
            obj.PextPoseBase = zeros(size, 9, 9);
        end
        ...
        function obj = updateCovPoseBase(obj, iter, PextPose)
            obj.PextPoseBase(iter, :, :) = PextPose;
        end
        ...
        function obj = setBasePosition(obj, pos)
            obj.basePos = pos;
        end

        function obj = setBaseRPY(obj, rpy)
            obj.baseRPY = rpy;
        end

        function obj = setBaseLinVel(obj, vel)
            obj.baseLinVel = vel;
        end
