...
% sensors_dev.accel_noise = [0.1 0.1 0.1]'; %acc_std;
% sensors_dev.gyro_noise = [0.01 0.01 0.01]'; %gyro_std
% sensors_dev.accel_bias_noise = [1e-3 1e-3 1e-3]';
% sensors_dev.gyro_bias_noise = [1e-5 1e-5 1e-5]';
% 
% sensors_dev.contact_foot_linvel_noise = [9e-4 9e-4 9e-6]'; % fix this
% sensors_dev.contact_foot_angvel_noise = [4e-3 4e-3 4e-3]'; % fix this
% sensors_dev.swing_foot_linvel_noise = [0.5 0.5 0.5]'; % fix this
% sensors_dev.swing_foot_angvel_noise = [0.5 0.5 0.5]'; % fix this
% sensors_dev.encoders_noise = deg2rad(1.5)*ones(nr_joints_est, 1);
